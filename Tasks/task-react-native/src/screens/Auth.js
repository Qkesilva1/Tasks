    ...
    render(){
        return(
            <ImageBackground source={backgroundImage} style={styles.background}>
                <StatusBar backgroundColor='#rgba(0, 0, 0, 0.1)' barStyle='light-content' translucent={true} />
                ...
                <View style={styles.formContainer}>
                    ...
                    {this.state.stageNew &&
                        <AuthInput icon='asterisk' placeholder='Confirme a senha' value={this.state.confirmPassword} style={styles.input} onChangeText={confirmPassword => this.setState({confirmPassword})} secureTextEntry={true} />
                    }
